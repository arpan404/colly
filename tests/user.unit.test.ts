...
describe('User Unit Tests', () => {
    ...
    describe('user.preferences.update', () => {
        ...
        it('should accept system theme when updating', async () => {
            const mockUpdateSystem = vi.fn().mockReturnValue({
                set: vi.fn().mockReturnValue({
                    where: vi.fn().mockReturnValue({
                        returning: vi.fn().mockResolvedValue([{
                            id: 'pref-id',
            ...
            mockDb.update = mockUpdateSystem;

            const caller = createAuthCaller();
            const result = await caller.user.preferences.update({ theme: 'system' as any });
